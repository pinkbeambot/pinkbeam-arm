...
>>>>>>> eng-ai/llm-improvements
            <div className="col-span-2">
              ...
              <p className="text-sm text-muted-foreground mb-6 max-w-xs">The command center for your AI workforce. Hire autonomous AI employees and scale your business without scaling your headcount.</p>
              <div className="space-y-3">
                <a href="mailto:hello@pinkbeam.io" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <Mail className="w-4 h-4" />hello@pinkbeam.io
                </a>
                <div className="flex items-center gap-2 text-sm text-muted-foreground"><MapPin className="w-4 h-4" />San Francisco, CA</div>
              </div>
            </div>
