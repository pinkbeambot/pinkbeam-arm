        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <FadeInOnMount delay={0}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/20 mb-6">
              ...
              <span className="text-sm font-medium text-pink-400">
                Limited: First 100 founders get 50% off first month
              </span>
            </div>
          </FadeInOnMount>
          ...
          <FadeInOnMount delay={0.15}>
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-6">
              Hire AI employees that work 24/7. No salaries, no benefits, no burnout. 
              Just results.
            </p>
          </FadeInOnMount>
          ...
          <FadeInOnMount delay={0.25}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button 
                size="lg" 
                variant="beam" 
                className="w-full sm:w-auto text-base px-8 py-6 shadow-beam hover:shadow-glow-pink-md transition-shadow group" 
                asChild
              >
                <Link href="/auth">
                  Start Free Trial
              ...
              <Button 
                size="lg" 
                className="w-full sm:w-auto text-base px-8 py-6 border border-gray-600 bg-transparent text-white hover:bg-white/10" 
                asChild
              >
                <Link href="/agents">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
                {companyLogos.map((logo) => (
                  ...
                  >
                    <span className="font-semibold text-gray-400 text-sm md:text-base tracking-wide">
                      {logo.display}
                    </span>
                  </div>
                ))}
