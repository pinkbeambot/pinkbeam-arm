...
<<<<<<< HEAD
                <div
                  key={t.author}
                  className="w-8 h-8 rounded-full bg-gradient-to-br from-primary/30 to-pink-500/30 border-2 border-background flex items-center justify-center text-xs font-bold text-primary"
                >
=======
...
<<<<<<< HEAD
            <span className="text-sm text-muted-foreground">
              Join <span className="font-semibold text-foreground">500+ founders</span> scaling with AI
            </span>
=======
