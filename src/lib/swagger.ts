...
export const getApiDocs = async () => {
  const spec = {
      ...
      tags: [
        ...
        { name: 'Billing', description: 'Subscription management, invoices, and usage tracking' },
        { name: 'Notifications', description: 'Email notifications and digest management' },
      ],
      paths: allPaths,
      components: {
        securitySchemes: {
        ...
        schemas: {
          ...
          BillingInfo: {
            ...
            properties: {
              ...
              subscription_status: { type: 'string', enum: ['trialing', 'active', 'canceled', 'past_due', 'unpaid'] },
              trial_ends_at: { type: 'string', format: 'date-time', nullable: true },
              current_period_starts_at: { type: 'string', format: 'date-time', nullable: true },
            ...
            required: ['id', 'tenant_id', 'current_tier', 'subscription_status', 'created_at', 'updated_at'],
          },
          SubscriptionTier: {
            type: 'object',
            properties: {
              ...
              description: { type: 'string' },
              stripe_price_id: { type: 'string', nullable: true },
              agent_limit: { type: 'integer', nullable: true },
              task_limit: { type: 'integer', nullable: true },
              storage_gb: { type: 'integer', nullable: true },
              api_calls_per_day: { type: 'integer', nullable: true },
              features: { type: 'array', items: { type: 'string' } },
              is_active: { type: 'boolean' },
              display_order: { type: 'integer' },
            },
            required: ['id', 'name', 'display_order', 'is_active'],
          },
          UsageWithLimits: {
            type: 'object',
            properties: {
              ...
              storage: {
                ...
                properties: {
                  used_mb: { type: 'number' },
                  limit_mb: { type: 'number', nullable: true },
                  percentage: { type: 'number' },
                },
                required: ['used_mb', 'percentage'],
              },
              api_calls: {
                type: 'object',
                properties: {
                  used_today: { type: 'integer' },
                  limit_per_day: { type: 'integer', nullable: true },
                  percentage: { type: 'number' },
                },
                required: ['used_today', 'percentage'],
              },
            },
            required: ['agents', 'tasks', 'storage', 'api_calls'],
          },
          Invoice: {
            type: 'object',
            properties: {
              ...
              hosted_invoice_url: { type: 'string', format: 'uri', nullable: true },
            },
          ...
          Notification: {
            ...
            required: ['id', 'tenant_id', 'user_id', 'type', 'title', 'message', 'created_at'],
          },
          NotificationPreference: {
            ...
            required: ['id', 'tenant_id', 'user_id', 'notification_type', 'channels', 'created_at', 'updated_at'],
          },
        },
      },
      security: [
