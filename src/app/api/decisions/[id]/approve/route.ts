 ...
 *     description: Approve a proposed decision. Changes status from 'proposed' to 'approved'.
 *     tags:
 *       - Decisions
 *     security:
 *       - BearerAuth: []
 ...
 *     responses:
 *       200:
 *         description: Decision approved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       400:
 *         description: Validation error or decision cannot be approved
 *       401:
