...
function dateRangeToPreset(dateRange: DateRange): 'today' | '7d' | '30d' | '90d' {
  ...
  // Only return valid presets, default to '30d' for custom or undefined
...
export default function AnalyticsPage() {
  ...
  const datePreset = useMemo(() => dateRangeToPreset(dateRange), [dateRange]);
  ...
  const activityData = useMemo(() => ({
    ...
    summary: {
      totalEvents: 142,
      eventsByType: { task: 45, decision: 30, agent: 25, escalation: 15, system: 27 },
      eventsByCategory: { task: 45, decision: 30, agent: 25, escalation: 15, system: 27 },
    },
  }), []);
