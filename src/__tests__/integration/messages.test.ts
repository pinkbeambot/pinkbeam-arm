...
describe('Messages API Integration', () => {
  ...
  describe('Message Creation', () => {
    it('should create a direct message between agents', async () => {
    ...
    it('should create a message with thread_id', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
    ...
    it('should create a message requiring acknowledgment', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
    ...
    it('should reject message with invalid message_type', async () => {
  ...
  describe('Message Retrieval', () => {
    it('should fetch messages by agent_id (sender)', async () => {
    ...
    it('should fetch messages by agent_id (recipient)', async () => {
      const { data: messages, error } = await supabase
        .from('messages')
        .select('*')
        .eq('tenant_id', testTenantId)
    ...
    it('should fetch messages by thread_id', async () => {
  ...
  describe('Message Updates', () => {
    ...
    it('should update message payload', async () => {
      const { data: message } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
  ...
  describe('Message Thread Operations', () => {
    it('should retrieve all messages in a thread with participants', async () => {
      const { data: messages, error } = await supabase
        .from('messages')
        .select(`
          *,
  ...
  describe('Message Priority', () => {
    it('should create messages with different priorities', async () => {
  ...
  describe('Message Protocol Types', () => {
    it('should create spawn request message', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
    ...
    it('should create task assignment message', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
    ...
    it('should create decision proposal message', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
    ...
    it('should create escalation request message', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
    ...
    it('should create system ping message', async () => {
      const { data: message, error } = await supabase
        .from('messages')
        .insert({
          tenant_id: testTenantId,
