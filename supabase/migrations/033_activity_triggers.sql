...
COMMENT ON FUNCTION log_activity() IS 'Enhanced trigger function for logging activities. Logs task.created/task.status_changed, decision.proposed/decision.*, escalation.created/escalation.resolved';
